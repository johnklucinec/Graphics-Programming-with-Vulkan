...
const double FOV 	= glm::radians(60.0);	// field-of-view angle
const float EYEDIST = 30.0;					// eye distance
const float OMEGA 	= 2.0 * M_PI;			// angular velocity, radians/sec
...
Keytimes MarioR, MarioG, MarioB;
Keytimes ThetaX, ThetaY, ThetaZ;
Keytimes ScaleXYZ;

Keytimes BlockXpos, BlockYpos, BlockZpos;
Keytimes BlockThetaX, BlockThetaY, BlockThetaZ;
Keytimes BlockScaleXYZ;

Keytimes StarXpos, StarYpos, StarZpos;
Keytimes StarThetaX, StarThetaY, StarThetaZ;
Keytimes StarScaleXYZ;
...
struct objectBuf		Object2;
struct objectBuf		Object3;
...
MyBuffer			MyObjectUniformBuffer2;
MyBuffer			MyObjectUniformBuffer3;
MyBuffer			MyVertexDataBuffer;
MyBuffer			MyVertexDataBuffer2;
MyBuffer			MyVertexDataBuffer3;
...
InitGraphics( )
{
	...
	Init05UniformBuffer( sizeof(Object2),	&MyObjectUniformBuffer2 );
	Fill05DataBuffer( MyObjectUniformBuffer2,	(void *) &Object2 );

	Init05UniformBuffer( sizeof(Object3),	&MyObjectUniformBuffer3 );
	Fill05DataBuffer( MyObjectUniformBuffer3,	(void *) &Object3 );

	MyVertexDataBuffer = VkuLoadObjFile((char *)"mario.obj");
	MyVertexDataBuffer2 = VkuLoadObjFile((char *)"cube.obj");
	MyVertexDataBuffer3 = VkuLoadObjFile((char *)"star.obj");
	...
	// Mario Keytimes
	// Starting Red
	MarioR.AddTimeValue(0.0f, 1.0f);
	MarioR.AddTimeValue(7.59f, 1.0f);
	MarioR.AddTimeValue(8.00f, 1.0f);
	MarioR.AddTimeValue(10.0f, 1.0f);

	// First Rainbow Cycle
	MarioR.AddTimeValue(10.24f, 1.0f);
	MarioR.AddTimeValue(10.48f, 1.0f);
	MarioR.AddTimeValue(10.71f, 0.0f);
	MarioR.AddTimeValue(10.95f, 0.0f);
	MarioR.AddTimeValue(11.19f, 0.0f);
	MarioR.AddTimeValue(11.43f, 0.5f);
	MarioR.AddTimeValue(11.67f, 1.0f);

	// Second Rainbow Cycle
	MarioR.AddTimeValue(11.91f, 1.0f);
	MarioR.AddTimeValue(12.14f, 1.0f);
	MarioR.AddTimeValue(12.38f, 0.0f);
	MarioR.AddTimeValue(12.62f, 0.0f);
	MarioR.AddTimeValue(12.86f, 0.0f);
	MarioR.AddTimeValue(13.10f, 0.5f);
	MarioR.AddTimeValue(13.33f, 1.0f);

	// Third Rainbow Cycle
	MarioR.AddTimeValue(13.57f, 1.0f);
	MarioR.AddTimeValue(13.81f, 1.0f);
	MarioR.AddTimeValue(14.05f, 0.0f);
	MarioR.AddTimeValue(14.29f, 0.0f);
	MarioR.AddTimeValue(14.52f, 0.0f);
	MarioR.AddTimeValue(14.76f, 0.5f);
	MarioR.AddTimeValue(15.0f, 1.0f);

	// Green Channel
	MarioG.AddTimeValue(0.0f, 0.0f);
	MarioG.AddTimeValue(7.59f, 0.0f);
	MarioG.AddTimeValue(8.00f, 0.0f);
	MarioG.AddTimeValue(10.0f, 0.0f);

	// First Cycle
	MarioG.AddTimeValue(10.24f, 0.5f);
	MarioG.AddTimeValue(10.48f, 1.0f);
	MarioG.AddTimeValue(10.71f, 1.0f);
	MarioG.AddTimeValue(10.95f, 1.0f);
	MarioG.AddTimeValue(11.19f, 0.0f);
	MarioG.AddTimeValue(11.43f, 0.0f);
	MarioG.AddTimeValue(11.67f, 0.0f);

	// Second Cycle
	MarioG.AddTimeValue(11.91f, 0.5f);
	MarioG.AddTimeValue(12.14f, 1.0f);
	MarioG.AddTimeValue(12.38f, 1.0f);
	MarioG.AddTimeValue(12.62f, 1.0f);
	MarioG.AddTimeValue(12.86f, 0.0f);
	MarioG.AddTimeValue(13.10f, 0.0f);
	MarioG.AddTimeValue(13.33f, 0.0f);

	// Third Cycle
	MarioG.AddTimeValue(13.57f, 0.5f);
	MarioG.AddTimeValue(13.81f, 1.0f);
	MarioG.AddTimeValue(14.05f, 1.0f);
	MarioG.AddTimeValue(14.29f, 1.0f);
	MarioG.AddTimeValue(14.52f, 0.0f);
	MarioG.AddTimeValue(14.76f, 0.0f);
	MarioG.AddTimeValue(15.0f, 0.0f);

	// Blue Channel
	MarioB.AddTimeValue(0.0f, 0.0f);
	MarioB.AddTimeValue(7.59f, 0.0f);
	MarioB.AddTimeValue(8.00f, 0.0f);
	MarioB.AddTimeValue(10.0f, 0.0f);

	// First Cycle
	MarioB.AddTimeValue(10.24f, 0.0f);
	MarioB.AddTimeValue(10.48f, 0.0f);
	MarioB.AddTimeValue(10.71f, 0.0f);
	MarioB.AddTimeValue(10.95f, 1.0f);
	MarioB.AddTimeValue(11.19f, 1.0f);
	MarioB.AddTimeValue(11.43f, 0.5f);
	MarioB.AddTimeValue(11.67f, 0.0f);

	// Second Cycle
	MarioB.AddTimeValue(11.91f, 0.0f);
	MarioB.AddTimeValue(12.14f, 0.0f);
	MarioB.AddTimeValue(12.38f, 0.0f);
	MarioB.AddTimeValue(12.62f, 1.0f);
	MarioB.AddTimeValue(12.86f, 1.0f);
	MarioB.AddTimeValue(13.10f, 0.5f);
	MarioB.AddTimeValue(13.33f, 0.0f);

	// Third Cycle
	MarioB.AddTimeValue(13.57f, 0.0f);
	MarioB.AddTimeValue(13.81f, 0.0f);
	MarioB.AddTimeValue(14.05f, 0.0f);
	MarioB.AddTimeValue(14.29f, 1.0f);
	MarioB.AddTimeValue(14.52f, 1.0f);
	MarioB.AddTimeValue(14.76f, 0.5f);
	MarioB.AddTimeValue(15.0f, 0.0f);


	Xpos.AddTimeValue(0.0f, -10.0f);
	Xpos.AddTimeValue(2.0f, -10.0f);
	Xpos.AddTimeValue(4.0f, 0.0f);
	Xpos.AddTimeValue(4.01f, 0.0f);
	Xpos.AddTimeValue(7.0f, 0.0f);
	Xpos.AddTimeValue(7.01f, 0.0f);
	Xpos.AddTimeValue(10.0f, 8.0f);
	Xpos.AddTimeValue(15.0f, -10.0f);

	Ypos.AddTimeValue(0.0f, 0.0f);
	Ypos.AddTimeValue(3.75f, 0.0f);
	Ypos.AddTimeValue(4.0f, 2.0f);
	Ypos.AddTimeValue(4.01f, 2.0f);
	Ypos.AddTimeValue(7.00f, 2.0f);
	Ypos.AddTimeValue(7.01f, 2.0f);
	Ypos.AddTimeValue(7.50f, 0.0f);
	Ypos.AddTimeValue(10.00f, 0.0f);
	Ypos.AddTimeValue(10.05f, 0.0f);
	Ypos.AddTimeValue(13.05f, 15.0f);
	Ypos.AddTimeValue(15.0f, 0.0f);

	Zpos.AddTimeValue(0.0f, 0.0f);
	Zpos.AddTimeValue(15.0f, 0.0f);

	ScaleXYZ.AddTimeValue( 0.f,  0.5f);
	ScaleXYZ.AddTimeValue(15.f,  0.5f);

	ThetaX.AddTimeValue(0.0f, glm::radians(0.f));
	ThetaX.AddTimeValue(10.f, glm::radians(0.f));
	ThetaX.AddTimeValue(10.05f, glm::radians(0.f));
	ThetaX.AddTimeValue(11.5f, glm::radians(720.f));
	ThetaX.AddTimeValue(12.5f, glm::radians(0.f));
	ThetaX.AddTimeValue(13.5f, glm::radians(-720.f));
	ThetaX.AddTimeValue(15.f, glm::radians(0.f));

	ThetaY.AddTimeValue(0.0f, 0.0f);
	ThetaY.AddTimeValue(0.5f, glm::radians(90.0f));
	ThetaY.AddTimeValue(3.50f, glm::radians(90.0f));
	ThetaY.AddTimeValue(3.70f, glm::radians(135.0f));
	ThetaY.AddTimeValue(3.85f, glm::radians(90.0f));
	ThetaY.AddTimeValue(4.0f, glm::radians(0.0f));
	ThetaY.AddTimeValue(4.01f, glm::radians(0.0f));
	ThetaY.AddTimeValue(7.00f, glm::radians(0.0f));
	ThetaY.AddTimeValue(7.01f, glm::radians(0.0f));
	ThetaY.AddTimeValue(7.50f, glm::radians(90.0f));
	ThetaY.AddTimeValue(15.f, glm::radians(0.0f));

	// Block Keytimes
	BlockXpos.AddTimeValue(0.0f, 0.0f);
	BlockXpos.AddTimeValue(15.0f, 0.0f);

	BlockYpos.AddTimeValue(0.0f, 5.0f);
	BlockYpos.AddTimeValue(4.0f, 5.0f);
	BlockYpos.AddTimeValue(4.05f, 5.0f);
	BlockYpos.AddTimeValue(4.25f, 5.5f);
	BlockYpos.AddTimeValue(4.50f, 5.0f);
	BlockYpos.AddTimeValue(4.51f, 5.0f);
	BlockYpos.AddTimeValue(15.0f, 5.0f);

	BlockZpos.AddTimeValue(0.0f, 0.0f);
	BlockZpos.AddTimeValue(15.0f, 0.0f);

	BlockScaleXYZ.AddTimeValue( 0.f,  1.0f);
	BlockScaleXYZ.AddTimeValue(15.f,  1.0f);

	BlockThetaX.AddTimeValue(0.0f, 0.0f);
	BlockThetaX.AddTimeValue(15.f, glm::radians(0.f));

	BlockThetaY.AddTimeValue(0.0f, 0.0f);
	BlockThetaY.AddTimeValue(15.f, glm::radians(0.0f));

	// Star Keytimes
	StarXpos.AddTimeValue(0.0f, 0.0f);
	StarXpos.AddTimeValue( 5.01f,  0.0f);
	StarXpos.AddTimeValue( 6.50f,  0.0f);
	StarXpos.AddTimeValue( 6.51f,  0.0f);
	StarXpos.AddTimeValue( 8.98f,  15.0f);
	StarXpos.AddTimeValue( 10.0f,  8.0f);
	StarXpos.AddTimeValue( 10.01f,  0.0f);
	StarXpos.AddTimeValue(15.0f, 0.0f);

	StarYpos.AddTimeValue(0.0f, 5.0f);
	StarYpos.AddTimeValue( 4.49f,  5.0f);
	StarYpos.AddTimeValue( 4.5f,  5.0f);
	StarYpos.AddTimeValue( 5.0f,  7.5f);
	StarYpos.AddTimeValue( 5.01f,  7.5f);
	StarYpos.AddTimeValue( 7.0f,  7.5f);
	StarYpos.AddTimeValue( 7.01f,  7.5f);
	StarYpos.AddTimeValue( 7.50f,  0.0f);
	StarYpos.AddTimeValue( 7.51f,  0.0f);
	StarYpos.AddTimeValue( 10.0f,  0.0f);
	StarYpos.AddTimeValue( 10.01f,  0.0f);
	StarYpos.AddTimeValue(15.0f, 0.0f);

	StarZpos.AddTimeValue(0.0f, 0.0f);
	StarZpos.AddTimeValue(15.0f, 0.0f);

	StarScaleXYZ.AddTimeValue( 0.f,  0.0f);
	StarScaleXYZ.AddTimeValue( 4.49f,  0.0f);
	StarScaleXYZ.AddTimeValue( 4.5f,  0.0f);
	StarScaleXYZ.AddTimeValue( 5.0f,  0.15f);
	StarScaleXYZ.AddTimeValue( 5.01f,  0.15f);
	StarScaleXYZ.AddTimeValue( 9.98f,  0.15f);
	StarScaleXYZ.AddTimeValue( 9.999f,  0.15f);
	StarScaleXYZ.AddTimeValue( 10.0f,  0.0f);
	StarScaleXYZ.AddTimeValue( 10.001f,  0.0f);
	StarScaleXYZ.AddTimeValue(15.f,  0.0f);

	StarThetaX.AddTimeValue(0.0f, glm::radians(90.0f));
	StarThetaX.AddTimeValue(15.f, glm::radians(90.0f));

	StarThetaY.AddTimeValue(0.0f, 0.0f);
    StarThetaY.AddTimeValue(15.f, glm::radians(0.0f));
...
Init13DescriptorSets( )
{
	...
	VkDescriptorSetAllocateInfo		vdsaiObject2;
		vdsaiObject2.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO;
		vdsaiObject2.pNext = nullptr;
		vdsaiObject2.descriptorPool = DescriptorPool;
		vdsaiObject2.descriptorSetCount = 1;
		vdsaiObject2.pSetLayouts = &DescriptorSetLayouts[2];

	result = vkAllocateDescriptorSets( LogicalDevice, IN &vdsaiObject2, OUT &DescriptorSets[4] );
	REPORT( "vkAllocateDescriptorSets - Object2" );

	VkDescriptorBufferInfo			vdbi2b;
		vdbi2b.buffer = MyObjectUniformBuffer2.buffer;
		vdbi2b.offset = 0;
		vdbi2b.range = sizeof(Object2);

	VkWriteDescriptorSet			vwds2b;
		vwds2b.sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
		vwds2b.pNext = nullptr;
		vwds2b.dstSet = DescriptorSets[4];
		vwds2b.dstBinding = 0;
		vwds2b.dstArrayElement = 0;
		vwds2b.descriptorCount = 1;
		vwds2b.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
		vwds2b.pBufferInfo = &vdbi2b;
		vwds2b.pImageInfo = (VkDescriptorImageInfo *)nullptr;
		vwds2b.pTexelBufferView = (VkBufferView *)nullptr;

	vkUpdateDescriptorSets( LogicalDevice, 1, IN &vwds2b, IN copyCount, (VkCopyDescriptorSet *)nullptr );

	VkDescriptorSetAllocateInfo		vdsaiObject3;
		vdsaiObject3.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO;
		vdsaiObject3.pNext = nullptr;
		vdsaiObject3.descriptorPool = DescriptorPool;
		vdsaiObject3.descriptorSetCount = 1;
		vdsaiObject3.pSetLayouts = &DescriptorSetLayouts[2];

	result = vkAllocateDescriptorSets( LogicalDevice, IN &vdsaiObject3, OUT &DescriptorSets[5] );
	REPORT( "vkAllocateDescriptorSets - Object3" );

	VkDescriptorBufferInfo			vdbi2c;
		vdbi2c.buffer = MyObjectUniformBuffer3.buffer;
		vdbi2c.offset = 0;
		vdbi2c.range = sizeof(Object3);

	VkWriteDescriptorSet			vwds2c;
		vwds2c.sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
		vwds2c.pNext = nullptr;
		vwds2c.dstSet = DescriptorSets[5];
		vwds2c.dstBinding = 0;
		vwds2c.dstArrayElement = 0;
		vwds2c.descriptorCount = 1;
		vwds2c.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
		vwds2c.pBufferInfo = &vdbi2c;
		vwds2c.pImageInfo = (VkDescriptorImageInfo *)nullptr;
		vwds2c.pTexelBufferView = (VkBufferView *)nullptr;

	vkUpdateDescriptorSets( LogicalDevice, 1, IN &vwds2c, IN copyCount, (VkCopyDescriptorSet *)nullptr );
...
DestroyAllVulkan( )
{
	...
	vkDestroyBuffer(LogicalDevice, MyVertexDataBuffer2.buffer, PALLOCATOR);
	vkFreeMemory(LogicalDevice, MyVertexDataBuffer2.vdm, PALLOCATOR);
	vkDestroyBuffer(LogicalDevice, MyVertexDataBuffer3.buffer, PALLOCATOR);
	vkFreeMemory(LogicalDevice, MyVertexDataBuffer3.vdm, PALLOCATOR);
	...
	vkDestroyBuffer(LogicalDevice, MyObjectUniformBuffer2.buffer, PALLOCATOR);
	vkFreeMemory(LogicalDevice, MyObjectUniformBuffer2.vdm, PALLOCATOR);
	vkDestroyBuffer(LogicalDevice, MyObjectUniformBuffer3.buffer, PALLOCATOR);
	vkFreeMemory(LogicalDevice, MyObjectUniformBuffer3.vdm, PALLOCATOR);
...
RenderScene( )
{
	...
	const uint32_t vertexCountMario = (uint32_t)(MyVertexDataBuffer.size / sizeof(struct vertex));
	...
	vkCmdDraw( CommandBuffers[nextImageIndex], vertexCountMario, instanceCount, firstVertex, firstInstance );

	vkCmdBindDescriptorSets( CommandBuffers[nextImageIndex], VK_PIPELINE_BIND_POINT_GRAPHICS, GraphicsPipelineLayout, 2, 1, &DescriptorSets[4], 0, (uint32_t *)nullptr );

	VkBuffer cubeBuffers[1] = { MyVertexDataBuffer2.buffer };
	vkCmdBindVertexBuffers( CommandBuffers[nextImageIndex], 0, 1, cubeBuffers, offsets );
	const uint32_t vertexCountCow = (uint32_t)(MyVertexDataBuffer2.size / sizeof(struct vertex));

	vkCmdDraw( CommandBuffers[nextImageIndex], vertexCountCow, instanceCount, firstVertex, firstInstance );

	vkCmdBindDescriptorSets( CommandBuffers[nextImageIndex], VK_PIPELINE_BIND_POINT_GRAPHICS, GraphicsPipelineLayout, 2, 1, &DescriptorSets[5], 0, (uint32_t *)nullptr );

	VkBuffer starBuffers[1] = { MyVertexDataBuffer3.buffer };
	vkCmdBindVertexBuffers( CommandBuffers[nextImageIndex], 0, 1, starBuffers, offsets );
	const uint32_t vertexCountStar = (uint32_t)(MyVertexDataBuffer3.size / sizeof(struct vertex));

	vkCmdDraw( CommandBuffers[nextImageIndex], vertexCountStar, instanceCount, firstVertex, firstInstance );
...
Reset( )
{
	...
	Object.uModel = glm::mat4(1.0f);
	Object.uNormal = glm::mat4(1.0f);
	Object2.uModel = glm::mat4(1.0f);
	Object2.uNormal = glm::mat4(1.0f);
	Object3.uModel = glm::mat4(1.0f);
	Object3.uNormal = glm::mat4(1.0f);
	//Object.uNormal = glm::mat4(glm::inverseTranspose(glm::mat3(Matrices.uModelMatrix)));
	Object.uColor = (glm::vec4(1.0, 0.0, 0.0, 1.0));
	Object2.uColor = (glm::vec4(0.0, 0.0, 1.0, 1.0));
	Object3.uColor = (glm::vec4(0.0, 1.0, 0.0, 1.0));
	...
	Object2.uShininess = 10.f;
	Object3.uShininess = 10.f;
...
UpdateScene( )
{
	...
	// Elements of Object, such as uModel, uNormal, uColor, and uShininess

	// Mario
	Object.uModel = glm::mat4(1.);          // identity
	Object.uModel = glm::translate(Object.uModel, glm::vec3(Xpos.GetValue(time), Ypos.GetValue(time), Zpos.GetValue(time)));
	...
	Object.uColor = glm::vec4( MarioR.GetValue(time), MarioG.GetValue(time), MarioB.GetValue(time), 1.0f );
	Object.uShininess = 32.f;

	// Block
	Object2.uModel = glm::mat4(1.);          // identity
	Object2.uModel = glm::translate(Object2.uModel, glm::vec3(BlockXpos.GetValue(time), BlockYpos.GetValue(time), BlockZpos.GetValue(time)));
	Object2.uModel = glm::rotate(Object2.uModel, BlockThetaX.GetValue(time), glm::vec3(1.f, 0.f, 0.f));
	Object2.uModel = glm::rotate(Object2.uModel, BlockThetaY.GetValue(time), glm::vec3(0.f, 1.f, 0.f));
	Object2.uModel = glm::scale(Object2.uModel, glm::vec3(BlockScaleXYZ.GetValue(time)));

	Object2.uNormal = glm::mat4(glm::inverseTranspose(glm::mat3(Scene.uSceneOrient*Object2.uModel)));
	Object2.uColor = glm::vec4(0.545f, 0.271f, 0.075f, 1.0f);
	Object2.uShininess = 5.f;

	// Star
	Object3.uModel = glm::mat4(1.);          // identity
	Object3.uModel = glm::translate(Object3.uModel, glm::vec3(StarXpos.GetValue(time), StarYpos.GetValue(time), StarZpos.GetValue(time)));
	Object3.uModel = glm::rotate(Object3.uModel, StarThetaX.GetValue(time), glm::vec3(1.f, 0.f, 0.f));
	Object3.uModel = glm::rotate(Object3.uModel, StarThetaY.GetValue(time), glm::vec3(0.f, 1.f, 0.f));
	Object3.uModel = glm::scale(Object3.uModel, glm::vec3(StarScaleXYZ.GetValue(time)));

	Object3.uNormal = glm::mat4(glm::inverseTranspose(glm::mat3(Scene.uSceneOrient*Object3.uModel)));
	Object3.uColor = glm::vec4(1.0f, 0.843f, 0.0f, 1.0f);
	Object3.uShininess = 10.f;

	Fill05DataBuffer( MyObjectUniformBuffer, IN (void *) &Object );
	Fill05DataBuffer( MyObjectUniformBuffer2, IN (void *) &Object2 );
	Fill05DataBuffer( MyObjectUniformBuffer3, IN (void *) &Object3 );
}
