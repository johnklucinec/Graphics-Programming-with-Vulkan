...
#define APP_SHORT_NAME	"Instancing Sample"
#define APP_LONG_NAME	"Vulkan Instancing Sample Program"
...
const float EYEDIST =	10.0;				// eye distance
...
//************************P4
	MyVertexDataBuffer = vkuSphere( 1.0, 20, 20 );
//************************P4
